      ...
      <div className={`transition-all duration-300 ${scrolled ? 'bg-white shadow-lg shadow-black/8' : 'bg-white shadow-sm'}`}>
        ...
        <div className="container-shell flex items-center justify-between border-b border-slate-100 py-3">
          ...
          <div className="hidden lg:flex items-center gap-3">
            <a href="tel:+254720267045" className="flex items-center gap-2 rounded-full border border-slate-200 px-4 py-1.5 text-xs text-slate-600 transition-all duration-200 hover:border-brand-green/40 hover:bg-brand-green/5 hover:text-brand-green">
