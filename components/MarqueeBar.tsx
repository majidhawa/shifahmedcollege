    ...
    <div className="relative z-50 bg-gradient-to-r from-brand-dark via-brand-green to-brand-dark overflow-hidden">
      ...
      <div className="container-shell relative flex items-center justify-between gap-4 py-2.5">
        ...
        <div className="flex shrink-0 items-center gap-3">
          <a href="/apply" className="rounded-full border border-brand-gold/60 bg-brand-gold/10 px-4 py-1.5 text-xs font-bold text-brand-gold transition-all duration-200 hover:bg-brand-gold hover:text-brand-dark">
            Apply Now →
          </a>
          <button onClick={() => setDismissed(true)} aria-label="Dismiss" className="flex h-6 w-6 items-center justify-center rounded-full text-white/40 transition hover:bg-white/10 hover:text-white text-xs">
            ✕
          </button>
        </div>
      </div>
