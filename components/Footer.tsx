      ...
      <div className="container-shell grid gap-10 py-14 md:grid-cols-3">
        <div>
          ...
          <p className="mt-3 max-w-sm text-sm leading-7 text-white/75">
            A modern website starter built to present the institution professionally, highlight admissions, and guide prospective students toward applying.
          </p>
          <div className="mt-5 flex items-center gap-2">
            <a href="#" aria-label="Facebook" className="flex h-8 w-8 items-center justify-center rounded-full border border-white/20 text-white/70 transition hover:bg-white/10 hover:text-white">
            ...
            <a href="#" aria-label="Instagram" className="flex h-8 w-8 items-center justify-center rounded-full border border-white/20 text-white/70 transition hover:bg-white/10 hover:text-white">
            ...
            <a href="#" aria-label="X" className="flex h-8 w-8 items-center justify-center rounded-full border border-white/20 text-white/70 transition hover:bg-white/10 hover:text-white">
