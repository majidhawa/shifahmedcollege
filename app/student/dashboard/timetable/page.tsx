  ...
  const fetchTimetable = useCallback(
    async (
      ...
      try {
        ...
        const response =
          await fetch(
            `/api/student/timetable?${params.toString()}`,
            {
              method: 'GET',
              credentials: 'include',
              cache: 'no-store',
        ...
        <div className="mb-5 flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-sm text-gray-500">
              Narrow your schedule by programme
              or status.
            </p>
          </div>
        </div>
        ...
        <div className="rounded-3xl border border-gray-200 bg-white p-7 shadow-sm">
          ...
          {!isCurrentWeek ? (
            <div className="rounded-2xl bg-gray-50 p-5 text-sm text-gray-500">
              ...
              to view today's classes.
            </div>
          ) : actualTodayEntries.length ===
            0 ? (
            <div className="rounded-2xl bg-gray-50 p-5 text-sm text-gray-500">
              You have no timetable entries
              scheduled for today.
            </div>
          ) : (
      ...
      <section className="rounded-3xl border border-gray-200 bg-white p-6 shadow-sm sm:p-7">
        <div className="mb-5 flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-sm text-gray-500">
              Use these labels to identify the
