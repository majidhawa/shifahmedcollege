...
const CONTACT = {
  ...
  emailHref:
    'mailto:admissions@shifahmedicalcollege.ac.ke',

  whatsappHref:
    'https://wa.me/254142068933',

  contactPage: '/contact',
};

/* =========================================================
   PARENT CONTACT COLLEGE PAGE
========================================================= */

export default function ParentContactCollegePage() {
  return (
    <main className="min-h-screen bg-[#f6f8f7] text-[#0c1f1a]">
      <div className="mx-auto w-full max-w-7xl px-4 py-6 sm:px-6 sm:py-8 lg:px-8">
          ...
          <div className="relative px-6 py-8 sm:px-8 sm:py-10 lg:px-10">
            <div className="max-w-3xl">
              ...
              <p className="mt-3 max-w-2xl text-sm leading-6 text-white/60 sm:text-base">
                Have a question about your child&apos;s
                admission, fees, documents, course,
                timetable, academic progress or college
        ...
        <section>
          <div className="mb-5">
            ...
            <p className="mt-2 max-w-2xl text-sm leading-6 text-gray-500">
              Our admissions and college support team can
              help you with questions concerning your child
              and their studies at Shifah Medical Training
              College.
            </p>
          </div>
          ...
          <div className="grid gap-5 md:grid-cols-2">
            ...
            <ContactCard
              icon={<Phone size={23} />}
              title="Call the College"
              description="Speak directly with the college team for assistance with your child's admission, studies or college-related concerns."
            ...
            <ContactCard
              ...
              title="WhatsApp the College"
              description="Use WhatsApp for convenient enquiries and quick communication with the college team."
              detail={CONTACT.phoneDisplay}
            ...
            <ContactCard
              ...
              description="Visit the college in person when you need direct assistance, clarification or further information."
        ...
        <div className="mt-5 grid gap-5 lg:grid-cols-3">
          ...
          <section className="rounded-2xl bg-[#0f4f3f] p-6 text-white shadow-sm sm:p-7">
            ...
            <p className="mt-2 text-sm leading-6 text-white/60">
              Have your child&apos;s admission number or
              application number available when contacting
              the college so we can locate the correct
              student record quickly.
            </p>
        ...
        <section className="mt-5 rounded-2xl border border-gray-100 bg-white p-6 shadow-sm sm:p-7">
          ...
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <h2 className="mt-1 text-lg font-bold text-[#0c1f1a]">
                What can the College help you with?
              </h2>

              <p className="mt-1 text-sm leading-6 text-gray-500">
                Our team can assist parents with a wide range
                of matters relating to their child&apos;s
        ...
        <section className="mt-5 overflow-hidden rounded-2xl border border-[#0f4f3f]/15 bg-white">
          ...
          <div className="flex flex-col gap-4 p-5 sm:flex-row sm:items-start sm:p-6">
            ...
            <div className="min-w-0">
              ...
              <p className="mt-1 text-sm leading-6 text-gray-600">
                When contacting the college about your child,
                you may be asked to provide information such as
                their name, admission number or application
                number so that authorised staff can identify
        ...
        <section className="mt-5 overflow-hidden rounded-2xl border border-[#d7a93b]/25 bg-[#fffdf5]">
          ...
          <div className="flex flex-col gap-4 p-5 sm:flex-row sm:items-start sm:p-6">
            ...
            <div className="min-w-0">
              ...
              <p className="mt-1 text-sm leading-6 text-gray-600">
                Never share your parent portal password, OTP,
                verification code or other login credentials
                with anyone. Authorised college staff will not
                need your password to assist you.
              </p>
