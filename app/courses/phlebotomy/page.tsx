...
const course = courses.find((c) => c.slug === 'phlebotomy')!;
        ...
        <Container className="grid gap-8 lg:grid-cols-3">
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            {course.targetAudience && (
              <div className="rounded-3xl border border-slate-100 bg-white p-8 shadow-soft">
                <h2 className="text-2xl font-bold text-brand-dark">Who Is This Course For?</h2>
                <div className="mt-4 h-0.5 w-10 rounded-full bg-brand-gold" />
          ...
          <div className="space-y-6">
            ...
            {course.technicalRequirements && (
              <div className="rounded-3xl border border-slate-100 bg-white p-6 shadow-soft">
                <h3 className="text-lg font-bold text-brand-dark">Technical Requirements</h3>
                <div className="mt-3 h-0.5 w-8 rounded-full bg-brand-gold" />
                <p className="mt-4 text-sm text-slate-600">{course.technicalRequirements}</p>
              </div>
            )}
