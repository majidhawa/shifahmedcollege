...
/*
 * IMPORTANT:
 * This is the same bucket used by the working
 * lecturer document view API.
 */
...
========================================================= */
    ...
    if (
      ...
      console.error(
        'STUDENT SUPABASE DOCUMENT VIEW ERROR:',
        {
          documentId,
          bucket:
            STORAGE_BUCKET,
