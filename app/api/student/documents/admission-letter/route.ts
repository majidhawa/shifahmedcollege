...
export async function GET(request: Request) {
  try {
    ...
    /* =====================================================
       RESOLVE STUDENT'S OWN ADMISSION
    ===================================================== */
    ...
    if (result.rows.length === 0) {
      return NextResponse.json(
        {
          success: false,
          message: 'No admission record was found for your application.',
        },
        { status: 404 }
      );
    }
    ...
    if (Number(admission.application_id) !== applicationId) {
      return NextResponse.json(
        {
          success: false,
          message: 'You do not have access to this admission record.',
        },
        { status: 403 }
      );
    }
