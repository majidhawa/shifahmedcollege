    ...
    <main>
        ...
        <Container className="grid gap-16 lg:grid-cols-[1.1fr_0.9fr] lg:items-center">
          ...
          <div>
            ...
            <div className="mt-8 flex flex-wrap gap-3">
              <Link
                href="/about"
                className="inline-flex items-center gap-2 rounded-full bg-brand-green px-6 py-3 text-sm font-semibold text-white shadow-md shadow-brand-green/20 transition-all hover:bg-brand-dark hover:-translate-y-0.5"
              >
                Learn More
              ...
              <Link
                href="/apply"
                className="inline-flex items-center gap-2 rounded-full border border-slate-200 px-6 py-3 text-sm font-semibold text-slate-700 transition-all hover:border-brand-green/40 hover:text-brand-green hover:bg-brand-green/5"
              >
                Apply Today
              </Link>
            </div>
      ...
      <section className="bg-slate-50 py-20">
        <Container>
          ...
          <h2 className="section-title mt-4">Explore our healthcare training programmes at Shifah.</h2>
        ...
        <Container>
          ...
          <div className="mt-14 grid gap-6 md:grid-cols-2 xl:grid-cols-4">
            {[
              {
                icon: (
                  <svg width="24" height="24" fill="none" stroke="currentColor" strokeWidth="1.8" viewBox="0 0 24 24"><path d="M22 11.08V12a10 10 0 1 1-5.93-9.14"/><polyline points="22 4 12 14.01 9 11.01"/></svg>
                ),
              ...
              {
                icon: (
                  <svg width="24" height="24" fill="none" stroke="currentColor" strokeWidth="1.8" viewBox="0 0 24 24"><path d="M18 8h1a4 4 0 0 1 0 8h-1"/><path d="M2 8h16v9a4 4 0 0 1-4 4H6a4 4 0 0 1-4-4V8z"/><line x1="6" y1="1" x2="6" y2="4"/><line x1="10" y1="1" x2="10" y2="4"/><line x1="14" y1="1" x2="14" y2="4"/></svg>
                ),
              ...
              {
                icon: (
                  <svg width="24" height="24" fill="none" stroke="currentColor" strokeWidth="1.8" viewBox="0 0 24 24"><circle cx="12" cy="12" r="10"/><polyline points="12 6 12 12 16 14"/></svg>
                ),
              ...
              {
                icon: (
                  <svg width="24" height="24" fill="none" stroke="currentColor" strokeWidth="1.8" viewBox="0 0 24 24"><path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/><path d="M23 21v-2a4 4 0 0 0-3-3.87"/><path d="M16 3.13a4 4 0 0 1 0 7.75"/></svg>
                ),
        ...
        <Container>
          ...
          <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
            {site.departments.map((dept, i) => (
              <div
                key={dept}
                className="group relative overflow-hidden rounded-3xl border border-slate-100 bg-slate-50 px-6 py-7 transition-all duration-300 hover:-translate-y-1.5 hover:border-brand-green/40 hover:bg-white hover:shadow-xl hover:shadow-brand-green/10"
              >
                {/* green left bar */}
