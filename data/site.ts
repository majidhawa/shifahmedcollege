...
export const site = {
  ...
  email: 'admissions@yourdomain.co.ke',
  heroSlides: [
    {
      image: '/images/hero10.jpeg',
  ...
  about:
    'Shifaah Medical Training College is positioned as a career-focused medical training institution in Kitale, committed to equipping learners with practical healthcare skills, ethical values, and a strong foundation for professional growth.',
  values: [
    {
      title: 'Excellence',
      text: 'We pursue the highest standards in education, training, and healthcare service.'
    },
    {
      title: 'Integrity',
      text: 'We uphold honesty, transparency, and ethical conduct in all interactions.'
    },
    {
      title: 'Evidence-Based Practice',
      text: 'We value informed training and care guided by best evidence, expertise, and human dignity.'
    },
    {
      title: 'Compassion',
      text: 'We foster empathy, sensitivity, and respect for every individual.'
    },
    {
      title: 'Collaboration',
      text: 'We promote teamwork and interdisciplinary communication for better outcomes.'
    },
    {
      title: 'Innovation',
      text: 'We embrace creativity, adaptability, and continuous improvement in learning and service.'
    }
  ],
  departments: [
    'Nursing Sciences',
...
export const courses: Course[] = [
  {
    ...
    heroImage: '/images/hero4.jpeg',
    summary: 'Gain hands-on skills in patient care, hygiene, mobility and elderly support. Start your healthcare career at Shifaah Medical Training College today.',
    overview: [
    ...
    accreditation: [
      'NITA accredited certificate recognized locally and internationally'
    ],
    careerPaths: [
      'Home care',
